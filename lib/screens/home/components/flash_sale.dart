...
import 'package:go_green/screens/components/Banner/M/banner_m_with_counter.dart';
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) => Padding(
              ...
              child: ProductCard(
                ...
                description: demoFlashSaleProducts[index].brandName,
                title: demoFlashSaleProducts[index].title,
                price: demoFlashSaleProducts[index].price.toString(),
                priceAfetDiscount:
